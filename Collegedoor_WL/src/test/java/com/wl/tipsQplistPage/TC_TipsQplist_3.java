...
public class TC_TipsQplist_3 extends BaseClass{
	...
	public void verifyTipsQplistFunctionality() throws InterruptedException {
		Log.startTestCase("Test for verify custom section dropdown");
		...
		tipsQpListPage.clickCustomSection();
		Log.info("click custom section");
		Thread.sleep(2000);
	}
}
