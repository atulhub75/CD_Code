...
public class TS5_Tips_TC5 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advance,sub=Physics and QP Pattern=5, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectQuestionPattern("MCMC01_MC01");
