...
public class TS5_Tips_TC6 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advance,sub=Physics and QP Pattern=6, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectQuestionPattern("SDC02_SC00");
