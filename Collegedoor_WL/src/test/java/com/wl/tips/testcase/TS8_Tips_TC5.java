...
public class TS8_Tips_TC5 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and verify question paper duration");
		...
		Thread.sleep(2000);
		tipsHomePage.QPDescription("MockAtul");
		tipsHomePage.examDuration("-10");
