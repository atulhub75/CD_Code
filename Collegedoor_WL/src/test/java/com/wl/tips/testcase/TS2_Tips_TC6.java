...
public class TS2_Tips_TC6 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advanced,sub=chemistry verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectSubject("Chemistry");
