...
public class TS3_Tips_TC1 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and section=Mechanisc, verify display questions");
