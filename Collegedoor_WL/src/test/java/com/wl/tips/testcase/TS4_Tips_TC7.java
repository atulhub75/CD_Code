...
public class TS4_Tips_TC7 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and difficulty=Easy,Medium,Difficult, verify display questions");
