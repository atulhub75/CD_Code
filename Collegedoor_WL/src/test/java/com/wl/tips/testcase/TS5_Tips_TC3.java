...
public class TS5_Tips_TC3 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advance,sub=Physics and QP Pattern=3, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectQuestionPattern("MCSC02_SC00");
