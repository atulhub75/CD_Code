...
public class TS1_Tips_TC1 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam type JEE Main and verify display questions");
