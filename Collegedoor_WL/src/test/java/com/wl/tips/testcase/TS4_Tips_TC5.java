...
public class TS4_Tips_TC5 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and difficulty=Easy,Difficult, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.SelectEasyDifficulty();
