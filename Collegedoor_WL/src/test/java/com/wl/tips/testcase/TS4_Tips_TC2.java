...
public class TS4_Tips_TC2 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and difficulty=Medium verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectDifficulty("Medium");
