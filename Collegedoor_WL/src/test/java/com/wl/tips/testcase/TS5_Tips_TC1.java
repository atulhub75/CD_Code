...
public class TS5_Tips_TC1 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advance,sub=Physics and QP Pattern=1, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectQuestionPattern("MCSC00_SC00");
