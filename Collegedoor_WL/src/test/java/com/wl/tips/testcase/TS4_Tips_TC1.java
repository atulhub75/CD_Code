...
public class TS4_Tips_TC1 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics and difficulty=Easy verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectDifficulty("Easy");
