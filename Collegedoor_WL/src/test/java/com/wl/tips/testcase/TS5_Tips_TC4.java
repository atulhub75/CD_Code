...
public class TS5_Tips_TC4 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advance,sub=Physics and QP Pattern=4, verify display questions");
		...
		Thread.sleep(2000);
		tipsHomePage.selectQuestionPattern("MCMC00_MC00");
