...
public class TS9_Tips_TC1 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Advanced,sub=Physics and verify create question paper");
		...
		tipsHomePage.SelectQuestion("25");
		...
		//Thread.sleep(2000);
		boolean result=tipsHomePage.popUpPresent();
		Assert.assertTrue(result);
		Log.endTestCase("TS9_Tips_TC1");
	}
}
