...
public class TS3_Tips_TC3 extends BaseClass{
	...
	public void verifyTipsFunction() throws Exception {
		Log.startTestCase("Test for select Exam JEE Main,sub=Physics,chapter=Unit Dimensions Errors and Vectors,Tiopc=Units & Dimensions verify display questions");
		...
		//Thread.sleep(2000);
		tipsHomePage.selectSection("Mechanics");
		//Thread.sleep(2000);
		Log.info("select section");
		tipsHomePage.selectChapter("Unit Dimensions Errors and Vectors");
		Log.info("select chapter");
		//Thread.sleep(2000);
		tipsHomePage.selectTopic("Units & Dimensions");
		Log.info("select Topic");
		Thread.sleep(2000);
