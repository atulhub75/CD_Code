...
public class BulkChangePassword_TC5 extends BaseClass{
	...
	public void verifyResetButtonFunction() throws InterruptedException {
		Log.startTestCase("Test for verify Reset button function");
		...
		bulkNewPasswordPage.clickRefreshButton();
		Log.info("click on Reset button");
		Thread.sleep(2000);
		Log.endTestCase("Finished Test BulkChangePassword_TC5");
	}
}
