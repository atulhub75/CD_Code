...
public class BulkUserCreation_TC8 extends BaseClass{
	...
	public void verifyBackButtonFunctionality() throws InterruptedException {
		...
		Thread.sleep(2000);
		userListHomePage=bulkUploadSheetPage.ClickBackButton();
		...
		Log.endTestCase("Finished Test BulkUserCreation_TC8");
	}
}
