...
public class AddUser_TC2 extends BaseClass{
	...
	public void AddNewUserMethod() throws Throwable {
		Log.info("Start AddUser for teacher test");
		...
		userListHomePage=addNewUserPage.verifyAddNewUserFunctionality1();
		boolean result=userListHomePage.validateMessage();
		Assert.assertTrue(result);
		Log.info("Finished AddUser_TC2 Test");
	}
}
