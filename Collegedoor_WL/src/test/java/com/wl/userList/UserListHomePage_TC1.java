...
public class UserListHomePage_TC1 extends BaseClass{
	...
	@Test
	public void searchDataByFilter() throws InterruptedException {
		...
		userListHomePage.searchData();
		Log.info("apply filter");
		Thread.sleep(2000);
		boolean result=userListHomePage.isPresent();
		Assert.assertTrue(result);
		Log.endTestCase("Finished Test UserListHomePage_TC1");
	}
}
