...
public class AddUser_TC1 extends BaseClass {
	...
	public void AddNewUserMethod() throws Throwable {
		Log.info("Start AddUser_TC1 test");
		...
		userListHomePage=addNewUserPage.verifyAddNewUserFunctionality();
		Log.info("User created successfully");
		boolean result=userListHomePage.validateMessage();
		Assert.assertTrue(result);
		Log.info("Finished AddNewUser Test");
	}
}
