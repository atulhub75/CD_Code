...
public class ReportAccess_TC4 extends BaseClass{
	...
	@Test
	public void verifyResetBtnFunction() throws InterruptedException {
		Log.startTestCase("Test for verify reset button functionality");
		...
		createReportAccessPage.clickResetButton();
		Log.info("click on reset button ");
		Log.endTestCase("Finished Test ReportAccess_TC4");
	}
}
