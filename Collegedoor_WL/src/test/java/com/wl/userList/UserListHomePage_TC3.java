...
public class UserListHomePage_TC3 extends BaseClass{
	...
	public void verifyDownloadFile() throws InterruptedException {
		Log.startTestCase("Test for verify download file functionality");
		...
		userListHomePage.verifyDownloadData();
		Log.info("click on download button");
		Thread.sleep(2000);
		Log.endTestCase("Finished Test UserListHomePage_TC3");
	}
}
