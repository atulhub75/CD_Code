...
public class ReportAccess_TC1 extends BaseClass{
	...
	@Test
	public void verifyReportAccessUtility() {
		Log.startTestCase("Test for click on report access button");
		...
		Log.endTestCase("Finished Test ReportAccess_TC1");
	}
