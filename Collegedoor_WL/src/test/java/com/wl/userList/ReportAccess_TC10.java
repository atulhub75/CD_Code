...
public class ReportAccess_TC10 extends BaseClass{
	...
	public void verifyMessage() throws InterruptedException {
		Log.startTestCase("Test for verify that in bulk report access sheet page \"tacher not found\" message ");
		...
		Thread.sleep(2000);
		String actual=bulkReportAccessSheetPage.verifyNotTeacherMsg();
		String expected="Error Existing (Teacher Not Found)";
		Assert.assertEquals(actual, expected);
		Log.endTestCase("Finished Test ReportAccess_TC10");
