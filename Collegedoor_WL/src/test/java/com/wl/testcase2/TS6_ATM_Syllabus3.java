...
public class TS6_ATM_Syllabus3 extends BaseClass{
	...
	public void verifyATMFunctionality() throws Throwable {
		Log.startTestCase("Test for part syllabus ,custom question paper and exam Jee Main");
		...
		Thread.sleep(2000);
		atmCreatePaperPage.enterQuestionInBox1("2");
