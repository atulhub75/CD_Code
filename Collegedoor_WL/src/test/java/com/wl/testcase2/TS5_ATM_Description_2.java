...
public class TS5_ATM_Description_2 extends BaseClass{
	...
	public void verifyATMFunctionality() throws Throwable {
		Log.startTestCase("Test for verify paper description is Empty");
		...
		atmCreatePaperPage.paperDescription("");
		...
		Log.endTestCase("TS5_ATM_Description_2");
	}
}
