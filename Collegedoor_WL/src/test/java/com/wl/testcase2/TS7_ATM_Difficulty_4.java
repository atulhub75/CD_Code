...
public class TS7_ATM_Difficulty_4 extends BaseClass{
	...
	public void verifyATMFunctionality() throws Throwable {
		Log.startTestCase("Test for paper Exam with full syllabus , Difficulty=Easy and exam Advanced");
		...
		Log.endTestCase("TS7_ATM_Difficulty_4");
	}
}
