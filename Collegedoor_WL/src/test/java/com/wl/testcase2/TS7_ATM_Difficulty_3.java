...
public class TS7_ATM_Difficulty_3 extends BaseClass{
	...
	public void verifyATMFunctionality() throws Throwable {
		Log.startTestCase("Test for paper Exam with full syllabus , Difficulty=Hard and exam Jee Main");
		...
		Log.endTestCase("TS7_ATM_Difficulty_3");
	}
}
