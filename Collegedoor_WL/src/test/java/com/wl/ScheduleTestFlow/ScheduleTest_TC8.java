...
public class ScheduleTest_TC8 extends BaseClass{
	...
	public void verifySchedulePaperFunctionality() throws Throwable {
		Log.startTestCase("Test for validate search result from date");
		...
		addStudentPage.selectFromAndToDate();
		Log.info("select from date and To date");
		addStudentPage.clickSearchBtn();
		Log.info("click search");
		boolean result=addStudentPage.validateResultFromName();
