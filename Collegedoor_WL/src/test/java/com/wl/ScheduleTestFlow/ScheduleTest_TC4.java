...
public class ScheduleTest_TC4 extends BaseClass{
	...
	public void verifySchedulePaperFunctionality() throws Throwable {
		Log.startTestCase("Test for select Exam and schedule it and click Export all Data");
		...
		scheduleTestDetailPage.clickExportAllData();
