...
public class ScheduleTest_TC5 extends BaseClass{
	...
	public void verifySchedulePaperFunctionality() throws Throwable {
		Log.startTestCase("Test for select Exam and schedule it and click Excel");
		...
		scheduleTestDetailPage.clickExcel();
		Log.info("Click Excel button");
		Thread.sleep(3000);
	}
}
