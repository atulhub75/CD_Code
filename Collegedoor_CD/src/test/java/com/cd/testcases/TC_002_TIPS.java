...
public class TC_002_TIPS extends BaseClass{
	...
	public void verifyQuestionSummary() throws InterruptedException {
		...
		String actualTital=tipsquestionpaperList.getPageTitle();
		Assert.assertEquals(actualTital, "CollegeDoors - Question Paper Builder");
	}
